			...
			<section className="px-[6.25%] py-[5rem] sm:py-12">
				...
				<div className="grid grid-cols-4 gap-5 lg:grid-cols-3 tab:grid-cols-2 sm:grid-cols-1">
					<div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
						...
						<div className="w-full h-[112px] bg-no-repeat bg-center bg-cover border-t-[1.5px] border-navy/80">
							<img
								className="w-full h-full object-center object-cover"
								src="/images/landing-page/ilustrasi-nutrisi.svg"
								alt="Ilustrasi Nutrisi Optimal"
							/>
						</div>
					</div>
					<div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
						...
						<div className="w-full h-[112px] bg-no-repeat bg-center bg-cover border-t-[1.5px] border-navy/80">
							<img
								className="w-full h-full object-center object-cover"
								src="/images/landing-page/ilustrasi-peta-nutrisi.svg"
								alt="Ilustrasi Peta Nutrisi"
							/>
						</div>
					</div>
					<div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
						...
						<div className="w-full h-[112px] bg-no-repeat bg-center bg-cover border-t-[1.5px] border-navy/80">
							<img
								className="w-full h-full object-center object-cover"
								src="/images/landing-page/ilustrasi-hitung-sehat.svg"
								alt="Ilustrasi Hitung Sehat"
							/>
						</div>
					</div>
					<div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
						...
						<div className="w-full h-[112px] bg-no-repeat bg-center bg-cover border-t-[1.5px] border-navy/80">
							<img
								className="w-full h-full object-center object-cover"
								src="/images/landing-page/ilustrasi-berat-seimbang.svg"
								alt="Ilustrasi Berat Seimbang"
							/>
						</div>
					</div>
				</div>
