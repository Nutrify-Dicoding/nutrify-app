        ...
        <>
                ...
                <div className="flex h-full flex-row justify-between items-center pt-[4rem]">
                    <div className="w-[42%] tab:w-[50%] md:w-full md:flex md:flex-col md:items-center">
                        <h1 className=" text-5xl text-navy font-bold lg:text-4xl tab:text-3xl md:text-mobile-5xl">
                            Gizi yang Tepat, Hidup yang
                            {' '}
                            <span className="text-orange">Lebih Baik!</span>
                            {' '}
                        </h1>
                        <div className="hidden relative md:block md:w-[300px] md:h-[300px] md:mt-6">
                            <div className="md:w-[300px] md:h-[300px] aspect-square relative z-[5] lg:w-[336px] lg:h-[336px] tab:w-[275px] tab:h-[275px] ">
                                <img className="w-full h-full" src="/images/landing-page/hero-image.png" alt="Hero" />
                            </div>
                            <img
            ...
            <section className="px-[6.25%] py-[5rem] sm:py-12">
                <div className="text-navy mb-12 sm:mb-8">
                    <h2 className="text-4xl font-bold sm:text-mobile-4xl">
                        Fitur
                        {' '}
                        <span className="text-orange">Unggulan</span>
                        {' '}
                        Kami
                    </h2>
                ...
                <div className="grid grid-cols-4 gap-5 lg:grid-cols-3 tab:grid-cols-2 sm:grid-cols-1">
                    <div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
                        ...
                        <div className="w-full h-[112px] bg-no-repeat bg-center bg-cover bg-[url('images/landing-page/ilustrasi-nutrisi.svg')] border-t-[1.5px] border-navy/80" />
                    </div>
                    <div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
                        <div className="p-7">
                        ...
                        <div className="w-full h-[112px] bg-no-repeat bg-center bg-cover bg-[url('images/landing-page/ilustrasi-peta-nutrisi.svg')] border-t-[1.5px] border-navy/80" />
                    </div>
                    <div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
                        <div className="p-7">
                        ...
                        <div className="w-full h-[112px] bg-no-repeat bg-center bg-cover bg-[url('images/landing-page/ilustrasi-hitung-sehat.svg')] border-t-[1.5px] border-navy/80" />
                    </div>
                    <div className="flex flex-col justify-between border-[1.5px] border-navy/80 rounded-[10px] text-navy overflow-hidden">
                        <div className="p-7">
                        ...
                        <div className="w-full h-[112px] bg-no-repeat bg-center bg-cover bg-[url('images/landing-page/ilustrasi-berat-seimbang.svg')] border-t-[1.5px] border-navy/80" />
                    </div>
                </div>
            </section>
                ...
                <div className="p-12 shadow-[0px_0px_56px_-7px_rgba(119,119,119,0.12)] lg:px-8 sm:px-4">
                    <div className="text-navy mb-12 sm:mb-8 text-center">
                        <h2 className="text-4xl font-bold sm:text-mobile-4xl">
                            Pencapaian
                            {' '}
                            <span className="text-orange">Nutrisi Seimbang</span>
                        </h2>
            ...
            <section className="px-[6.25%] py-[5rem] sm:py-12">
                <div className="text-navy mb-12 sm:mb-8">
                    <h2 className="text-4xl font-bold sm:text-mobile-4xl">
                        Eksplorasi
                        {' '}
                        <span className="text-orange">Ragam Makanan</span>
                        {' '}
                        Sehat
                    </h2>
                ...
                <div className="grid my-10 sm:grid-cols-1 tab:grid-cols-3 md:grid-cols-2 grid-cols-4 gap-5">
                    {foods.slice(0, 4).map((item, index) => <CardFood key={index} id={item._id} name={item.name} description={item.desc} fat={item.fat} calorie={item.cal} protein={item.protein} carbohydrate={item.carb} image={item.image.includes('http') ? item.image : 'https://picsum.photos/265/150'} />)}
            ...
            <section className="px-[6.25%] pb-[5rem]">
                <div className="h-[380px] flex flex-col justify-center items-center bg-[url('/images/landing-page/banner-promo.png')] bg-no-repeat bg-center bg-cover text-center text-white rounded-[1.25rem] tab:h-[280px] sm:h-[300px] sm:bg-right">
                    ...
                    <Link to="/signup">
                        <Button buttonText="Daftar Sekarang" />
                    </Link>
                </div>
            </section>
        </>
