                ...
                <div className="w-full px-[60px] sm:px-8 py-8 bg-white/10 backdrop-blur-[5px] rounded-md shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-wrap">
                        ...
                        <div className="mt-6 w-full flex justify-center">
                            <button type="submit" className={`text-[0.90rem] w-[16rem] sm:w-full bg-[#FB8500] px-2 py-1 h-11 rounded-md text-white transition-all duration-75 ${loading ? 'cursor-wait bg-[#d66f00f5]' : 'cursor-pointer'}`}>
                                Register
                            </button>
                        </div>
                    </form>
