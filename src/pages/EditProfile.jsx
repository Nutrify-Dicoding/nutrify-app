	...
	return (
		<section className="pt-24 px-[6.25%] text-navy mb-20 sm:mb-12">
			...
			<div className="border p-5 rounded-lg mt-2">
				...
				<div className="grid grid-cols-2 sm:grid-cols-1 gap-5 mt-5">
					...
					<div className="sm:pe-0">
						...
						<select
							...
							onChange={handleInputChange}
							value={user.gender || ''}
							className="p-3 w-full bg-white-100 outline-gray-500 focus:outline-white-400"
						>
					...
					<div className="sm:pe-0">
						<div className="font-medium">Tingkat Kegiatan</div>
						<select
							value={user.levelActivity || 1}
