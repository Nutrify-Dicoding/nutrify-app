...
const Login = () => {
    return (
        ...
        <form action="" className="mt-1">
            <input type="text" className="block w-full mt-3 rounded-md h-9 p-3 placeholder-[#002140] text-xs" placeholder="Email"/>
            <input type="password" className="block w-full mt-3 rounded-md h-9 p-3 placeholder-[#002140] text-xs" placeholder="Password"/>
            <button className="mt-3 text-xs w-full bg-[#FB8500] px-2 py-1 h-8 rounded-md text-white">Login</button>
        </form>
        <p className="mt-3 text-xs text-white">Belum punya akun? <a href="#" className="text-[#FB8500] font-bold">Register</a></p>
        </div>
        </div>
        </div>  
        </>
