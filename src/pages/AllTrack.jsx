        ...
        axios.get('/profile', config)
            .then((res) => {
                ...
                if (res.status === 200) {
                    ...
                    if (bmi < 18.5) {
                        dataBmi.advice = `Status BMI anda ${dataBmi.bodyText}, memerlukan peningkatan asupan nutrisi untuk mencapai rentang yang sehat.`;
                        ...
                        dataBmi.advice = `Status BMI anda ${dataBmi.bodyText}, memerlukan penyesuaian asupan nutrisi untuk mencapai rentang yang sehat.`;
                    }
                    ...
                    if (bbi >= 18.5 && bbi <= 24.9) {
                        dataBbi.advice = 'Selamat! Berat badan Anda sudah ideal. Tetap jaga pola makan sehat untuk kesehatan yang optimal.';
                    } else {
                        dataBbi.advice = 'Untuk memperoleh berat badan ideal anda harus memiliki nilai body mass index 18.5 sampai 24.9 ayo mulai pola hidup sehat.';
                    }
