									...
									<ul className="mt-6 ms-[-171px] lg:ms-[-240px] w-[200px] lg:w-[260px]">
										...
										<li className="bg-white py-2 px-5 border">
											<Link to={'/profile'} onClick={() => setIsOpen(!isOpen)} className='block w-full'>
												<svg className='inline me-3 text-orange-100' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4Z"></path></svg>
												Profile
											</Link>
										</li>
										<li className="bg-white py-2 px-5 border">
										...
										<li className="bg-white py-2 px-5 border rounded-b-md" role="button" onClick={() => logout()}>
											<svg className='inline me-3 text-orange-100' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="m17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5M4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5Z"></path></svg>
											Logout
										</li>
									</ul>
								</div>
