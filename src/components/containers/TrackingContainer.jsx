	...
	return (
		<div className="mt-6 grid grid-cols-4 gap-5 lg:grid-cols-2 sm:grid-cols-1">
			<CardTrackStats
				...
				value={parseInt(nutritionTotal.totFat ?? 0)}
				name="Lemak"
			/>
			<CardTrackStats
				color="text-rose-400"
				...
				value={parseInt(nutritionTotal.totCal ?? 0)}
				name="Kalori"
			/>
			<CardTrackStats
				color="text-cyan-900"
				...
				value={parseInt(nutritionTotal.totProtein ?? 0)}
				name="Protein"
			/>
			<CardTrackStats
				color="text-orange"
				...
				value={parseInt(nutritionTotal.totCarb ?? 0)}
				name="Karbohidrat"
			/>
		</div>
	);
