...
function CardFood({
    id, name, description, fat, calorie, protein, carbohydrate, image,
}) {
    return (
                ...
                <div className="px-2">
                    <div className="w-full grid grid-cols-4 gap pb-4">
                        <div className="text-xs flex justify-center gap-1 items-center text-navy sm:flex-col">
                            <img src="/icons/cloud-meatball-solid.svg" className="inline h-[18px] sm:h-4" alt="fat" />
                            {' '}
                            {fat}
                        </div>
                        <div className="text-xs  flex justify-center gap-1 items-center text-navy sm:flex-col">
                            <img src="/icons/fire-solid.svg" className="inline h-[18px] sm:h-4" alt="calorie" />
                            {' '}
                            {calorie}
                        </div>
                        <div className="text-xs flex justify-center gap-1 items-center  text-navy sm:flex-col">
                            <img src="/icons/dna-solid.svg" className="inline h-[18px] sm:h-4" alt="protein" />
                            {' '}
                            {protein}
                        </div>
                        <div className="text-xs flex justify-center gap-1 items-center  text-navy sm:flex-col">
                            <img src="/icons/wheat-awn-solid.svg" className="inline h-[18px] sm:h-4" alt="carbohydrate" />
                            {' '}
                            {carbohydrate}
                        </div>
                    </div>
