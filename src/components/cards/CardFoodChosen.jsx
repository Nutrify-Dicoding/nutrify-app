		...
		>
			<div className="w-[25%] 2lg:w-[27%] tab:flex tab:justify-between tab:items-center tab:w-full">
				<div className="flex flex-row gap-5 items-center">
					<img src={selectedFood.image} alt={'Gambar Makanan'} className="w-[70px] 2lg:w-14 h-[70px] 2lg:h-14 rounded-full" />
			...
			<div className="w-[55%] tab:w-full tab:mt-2 grid grid-cols-4 gap-5 sm:gap-2 sm:mr-4">
				<NutritionWrap name={'Lemak'} icon={'icon-lemak-no-bg.svg'} value={selectedFood.fat} />
				<NutritionWrap name={'Kalori'} icon={'icon-calori-no-bg.svg'} value={selectedFood.cal} />
				<NutritionWrap name={'Protein'} icon={'icon-protein-no-bg.svg'} value={selectedFood.protein} />
				<NutritionWrap name={'Karbohidrat'} icon={'icon-karbo-no-bg.svg'} value={selectedFood.carb} />
			</div>
