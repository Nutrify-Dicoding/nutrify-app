function PlaceholderCardFood() {
  return (
    <div className="col-span-1 mx-auto bg-white animate-pulse rounded-lg shadow-[0px_0px_44px_-5px_rgba(0,0,0,0.10)] w-full">
      <div className="bg-slate-200 h-[150px] w-full rounded-t-lg" />
      <div className="pt-5 pb-7 px-[14px] sm:px-[10px]">
        <div className="sm:text-mobile-xl w-1/2 h-5 bg-slate-200 mb-2 rounded" />
        <p className="text bg-slate-200 h-5 w-full rounded" />
