...
const NutritionWrap = () => {
	return (
		<div className="h-14 flex flex-col justify-center  items-center py-2">
			<p className="opacity-90 sm:text-sm bg-slate-200 w-1/2 h-[1rem]"></p>
...
const PlaceholderCardFoodHistory = ({ data, portion }) => {
	return (
		<>
			<div className="flex justify-between items-center tab:flex-col w-full mt-5 border border-white-400/60 rounded-[10px] p-4 sm:p-2 animate-pulse">
				<div className="w-[25%] 2lg:w-[27%] tab:flex tab:justify-between tab:items-center tab:w-full">
					<div className="flex flex-row gap-5 items-center">
						<div className="min-w-[70px] 2lg:w-14 h-[70px] 2lg:h-14 rounded-full bg-slate-200"></div>
						<div className="flex flex-col h-14 text-navy w-full">
							<p className="text-lg w-full h-[1rem] bg-slate-200"></p>
							<p className="text-sm text-slate-500 w-1/2 h-[1rem] mt-1 bg-slate-200"></p>
						</div>
					</div>
